...
func (x *CollectResponse) GetBiz() string {
	if x != nil {
		return x.Biz
	}
	return ""
...
func (x *CollectResponse) GetBizId() int64 {
	if x != nil {
		return x.BizId
	}
	return 0
...
func (x *CollectResponse) GetUid() int64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
const file_intr_v1_interactive_proto_rawDesc = "" +
	"\n" +
	"\x19intr/v1/interactive.proto\x12\aintr.v1\"=\n" +
	...
	"\x03cid\x18\x04 \x01(\x03R\x03cid\"L\n" +
	"\x0fCollectResponse\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x15\n" +
	"\x06biz_id\x18\x02 \x01(\x03R\x05bizId\x12\x10\n" +
	"\x03uid\x18\x03 \x01(\x03R\x03uid\"G\n" +
	"\n" +
	"GetRequest\x12\x10\n" +
	"\x03biz\x18\x01 \x01(\tR\x03biz\x12\x15\n" +
	"\x06biz_id\x18\x02 \x01(\x03R\x05bizId\x12\x10\n" +
	"\x03uid\x18\x03 \x01(\x03R\x03uid\"\xc1\x01\n" +
	...
	"\bGetByIds\x12\x18.intr.v1.GetByIdsRequest\x1a\x19.intr.v1.GetByIdsResponseB\x92\x01\n" +
	"\vcom.intr.v1B\x10InteractiveProtoP\x01Z4github.com/jym0818/mywe/api/proto/gen/intr/v1;intrv1\xa2\x02\x03IXX\xaa\x02\aIntr.V1\xca\x02\aIntr\\V1\xe2\x02\x13Intr\\V1\\GPBMetadata\xea\x02\bIntr::V1b\x06proto3"
